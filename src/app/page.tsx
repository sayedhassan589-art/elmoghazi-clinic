...
export default function Home() {
  ...
  const { patients, setPatients, visits, setVisits, sessions, setSessions, services, setServices, notes, setNotes, alerts, setAlerts, reminders, setReminders, laserRecords, setLaserRecords, transactions, setTransactions, appointments, setAppointments, waitingQueue, setWaitingQueue, inventoryItems, setInventoryItems, medications, setMedications, prescriptions, setPrescriptions, backups, setBackups, notifications, setNotifications, doctors, setDoctors, followUpRecords, setFollowUpRecords, loading, setLoading, patientPhotos, setPatientPhotos, loadAllData, loadCoreData, loadFinanceData, loadDashboardData, loadLaserData, loadMoreData, refreshPatientPhotos } = useDataStore(useShallow((s) => ({
    patients: s.patients, setPatients: s.setPatients, visits: s.visits, setVisits: s.setVisits, sessions: s.sessions, setSessions: s.setSessions, services: s.services, setServices: s.setServices, notes: s.notes, setNotes: s.setNotes, alerts: s.alerts, setAlerts: s.setAlerts, reminders: s.reminders, setReminders: s.setReminders, laserRecords: s.laserRecords, setLaserRecords: s.setLaserRecords, transactions: s.transactions, setTransactions: s.setTransactions, appointments: s.appointments, setAppointments: s.setAppointments, waitingQueue: s.waitingQueue, setWaitingQueue: s.setWaitingQueue, inventoryItems: s.inventoryItems, setInventoryItems: s.setInventoryItems, medications: s.medications, setMedications: s.setMedications, prescriptions: s.prescriptions, setPrescriptions: s.setPrescriptions, backups: s.backups, setBackups: s.setBackups, notifications: s.notifications, setNotifications: s.setNotifications, doctors: s.doctors, setDoctors: s.setDoctors, followUpRecords: s.followUpRecords, setFollowUpRecords: s.setFollowUpRecords, loading: s.loading, setLoading: s.setLoading, patientPhotos: s.patientPhotos, setPatientPhotos: s.setPatientPhotos, loadAllData: s.loadAllData, loadCoreData: s.loadCoreData, loadFinanceData: s.loadFinanceData, loadDashboardData: s.loadDashboardData, loadLaserData: s.loadLaserData, loadMoreData: s.loadMoreData, refreshPatientPhotos: s.refreshPatientPhotos,
  })))
  ...
  const { darkMode, setDarkMode, smartSearchOpen, setSmartSearchOpen, smartSearchQuery, setSmartSearchQuery, searchQuery, setSearchQuery, searchField, setSearchField, patientDisplayCount, setPatientDisplayCount, selectedPatient, setSelectedPatient, showAddPatient, setShowAddPatient, showAddTransaction, setShowAddTransaction, showAddLaserRecord, setShowAddLaserRecord, setShowAddAppointment, loginRole, setLoginRole, loginPassword, setLoginPassword, loginLoading, setLoginLoading, seeded, setSeeded, restoreConfirmOpen, setRestoreConfirmOpen, pendingRestoreData, setPendingRestoreData, patientFilter, setPatientFilter, editingPatient, setEditingPatient, deletePatientConfirmOpen, setDeletePatientConfirmOpen, passwordDialogOpen, setPasswordDialogOpen, passwordTarget, setPasswordTarget, passwordInput, setPasswordInput, pendingTab, setPendingTab, selectedFollowUpId } = useUIStore(useShallow((s) => ({
    darkMode: s.darkMode, setDarkMode: s.setDarkMode, smartSearchOpen: s.smartSearchOpen, setSmartSearchOpen: s.setSmartSearchOpen, smartSearchQuery: s.smartSearchQuery, setSmartSearchQuery: s.setSmartSearchQuery, searchQuery: s.searchQuery, setSearchQuery: s.setSearchQuery, searchField: s.searchField, setSearchField: s.setSearchField, patientDisplayCount: s.patientDisplayCount, setPatientDisplayCount: s.setPatientDisplayCount, selectedPatient: s.selectedPatient, setSelectedPatient: s.setSelectedPatient, showAddPatient: s.showAddPatient, setShowAddPatient: s.setShowAddPatient, showAddTransaction: s.showAddTransaction, setShowAddTransaction: s.setShowAddTransaction, showAddLaserRecord: s.showAddLaserRecord, setShowAddLaserRecord: s.setShowAddLaserRecord, setShowAddAppointment: s.setShowAddAppointment, loginRole: s.loginRole, setLoginRole: s.setLoginRole, loginPassword: s.loginPassword, setLoginPassword: s.setLoginPassword, loginLoading: s.loginLoading, setLoginLoading: s.setLoginLoading, seeded: s.seeded, setSeeded: s.setSeeded, restoreConfirmOpen: s.restoreConfirmOpen, setRestoreConfirmOpen: s.setRestoreConfirmOpen, pendingRestoreData: s.pendingRestoreData, setPendingRestoreData: s.setPendingRestoreData, patientFilter: s.patientFilter, setPatientFilter: s.setPatientFilter, editingPatient: s.editingPatient, setEditingPatient: s.setEditingPatient, deletePatientConfirmOpen: s.deletePatientConfirmOpen, setDeletePatientConfirmOpen: s.setDeletePatientConfirmOpen, passwordDialogOpen: s.passwordDialogOpen, setPasswordDialogOpen: s.setPasswordDialogOpen, passwordTarget: s.passwordTarget, setPasswordTarget: s.setPasswordTarget, passwordInput: s.passwordInput, setPasswordInput: s.setPasswordInput, pendingTab: s.pendingTab, setPendingTab: s.setPendingTab, selectedFollowUpId: s.selectedFollowUpId,
  })))
  // Login
